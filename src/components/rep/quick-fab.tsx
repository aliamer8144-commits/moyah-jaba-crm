...
// Semicircle arc - first button starts below the FAB, then arcs upward
...
export function QuickFab() {
  ...
  return (
    <div className="fixed left-4 bottom-24 z-50" style={{ touchAction: 'none' }}>
      {/* Overlay */}
      <AnimatePresence>
        {isOpen && (
          <motion.div
